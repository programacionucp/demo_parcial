...
#  Jun 01, 2020 05:01:38 PM -03  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    place $site_3_0.tLa52 \
        ...
        -relwidth 0.013 -height 0 -relheight 0.106 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tLa53 \
        -in $site_3_0 -x 0 -relx 0.717 -y 0 -rely 0.487 -width 0 \
        -relwidth 0.028 -height 0 -relheight 0.106 -anchor nw \
        -bordermode ignore 
    ...
    place $top.lab48 \
        ...
        -height 0 -relheight 0.226 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 0 -relx 0.04 -y 0 -rely 0.756 -width 0 -relwidth 0.92 \
