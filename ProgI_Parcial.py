...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Labelframe1_3.place(relx=0.04, rely=0.76, relheight=0.222
                , relwidth=0.92)
        ...
        self.entryID = tk.Entry(self.Labelframe1_3)
        self.entryID.place(relx=0.196, rely=0.18, height=24, relwidth=0.157
                , bordermode='ignore')
        ...
        self.lblNombre = tk.Label(self.Labelframe1_3)
        self.lblNombre.place(relx=0.25, rely=0.36, height=26, width=202
                , bordermode='ignore')
        ...
        self.lblNombre.configure(text='''-''')

        self.lblProvincia = tk.Label(self.Labelframe1_3)
        self.lblProvincia.place(relx=0.217, rely=0.541, height=26, width=221
                , bordermode='ignore')
        ...
        self.lblProvincia.configure(text='''-''')

        self.lblViajes = tk.Label(self.Labelframe1_3)
        self.lblViajes.place(relx=0.283, rely=0.766, height=26, width=102
                , bordermode='ignore')
        self.lblViajes.configure(background="#d9d9d9")
        self.lblViajes.configure(disabledforeground="#a3a3a3")
        self.lblViajes.configure(foreground="#000000")
        self.lblViajes.configure(text='''-''')

        self.lblBloque = tk.Label(self.Labelframe1_3)
        self.lblBloque.place(relx=0.652, rely=0.18, height=26, width=172
                , bordermode='ignore')
        ...
        self.lblBloque.configure(text='''-''')

        self.lblAnio = tk.Label(self.Labelframe1_3)
        self.lblAnio.place(relx=0.652, rely=0.405, height=26, width=172
                , bordermode='ignore')
        self.lblAnio.configure(background="#d9d9d9")
        self.lblAnio.configure(disabledforeground="#a3a3a3")
        self.lblAnio.configure(foreground="#000000")
        self.lblAnio.configure(text='''-''')

        self.TButton4 = ttk.Button(self.Labelframe1_3)
        self.TButton4.place(relx=0.522, rely=0.676, height=30, width=98
                , bordermode='ignore')
        self.TButton4.configure(command=ProgI_Parcial_support.buscadorDiputados)
        self.TButton4.configure(takefocus="")
        self.TButton4.configure(text='''CALCULAR''')
