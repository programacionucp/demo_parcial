...
Dip_x_provincia = Frame(root, width=500, height=200, relief=SUNKEN, bd=20, bg='black')
Dip_x_provincia.pack()
Provinc_ = Label(Dip_x_provincia, text='Provincia: ', bg='black', fg='pink').place(x=20, y=30)
...
Calc_btn_1 = Button(Dip_x_provincia, text='Calcular', command=Diputados_x_provincia, bg='black', fg='pink').place(x=180, y=120)
Cantidad_1_lbl = Label(Dip_x_provincia, text='Cantidad: ', bg='black', fg='pink').place(x=230, y=60)
cantidad_1_var = StringVar(Dip_x_provincia)
Cantidad_1_entr = Entry(Dip_x_provincia, textvariable=cantidad_1_var, state=DISABLED)
Cantidad_1_entr.place(x=300, y= 60)
    #Frame_Diputados_por_Bloque_Político
Dip_x_bloque = Frame(root, width=500, height=200, relief=SUNKEN, bd=20, bg='black')
Dip_x_bloque.pack()
bloque_ = Label(Dip_x_bloque, text='Bloque: ', bg='black', fg='pink').place(x=20, y=30)
...
Calc_btn_2 = Button(Dip_x_bloque, text='Calcular', command=cantidad_diputados_x_bloque, bg='black', fg='pink').place(x=180, y=120)
Hombres_lbl = Label(Dip_x_bloque, text='Hombres: ', bg='black', fg='pink').place(x=230, y=60)
Mujeres_lbl = Label(Dip_x_bloque, text='Mujeres: ', bg='black', fg='pink').place(x=230, y=90)
hombres_var = StringVar(Dip_x_bloque)
mujeres_var = StringVar(Dip_x_bloque)
hombres_entr = Entry(Dip_x_bloque, textvariable=hombres_var, state=DISABLED)
hombres_entr.place(x=300, y= 60)
mujeres_entr = Entry(Dip_x_bloque, textvariable=mujeres_var, state=DISABLED)
mujeres_entr.place(x=300, y= 90)
    #Frame_Cantidad_Viajes
Cantidad_Viajes_F = Frame(root, width=500, height=200, relief=SUNKEN, bd=20, bg='black')
Cantidad_Viajes_F.pack()
Origen_ = Label(Cantidad_Viajes_F, text='Origen: ', bg='black', fg='pink').place(x=20, y=30)
Destino_ = Label(Cantidad_Viajes_F, text='Destino: ', bg='black', fg='pink').place(x=20, y=60)
...
Cantidad_2_lbl = Label(Cantidad_Viajes_F, text='Cantidad: ', bg='black', fg='pink').place(x=230, y=60)
cantidad_2_var = StringVar(Cantidad_Viajes_F)
Cantidad_2_entr = Entry(Cantidad_Viajes_F, textvariable=cantidad_2_var, state=DISABLED)
Cantidad_2_entr.place(x=300, y= 60)
    #Frame_Buscador_Diputados
Buscador_diputados = Frame(root, width=500, height=300, relief=SUNKEN, bd=20, bg='black')
Buscador_diputados.pack()
Diputado_id = Label(Buscador_diputados, text='Diputado ID: ', bg='black', fg='pink').place(x=20, y=30)
...
Buscar_btn = Button(Buscador_diputados, text='Buscar', command=Buscador_diputados_func, bg='black', fg='pink').place(x=300, y=30)

Nombre_completo_lbl = Label(Buscador_diputados, text='Nombre completo: ', bg='black', fg='pink').place(x=20, y=60)
Nombre_completo_entr_var = StringVar(Buscador_diputados)
Nombre_completo_entr = Entry(Buscador_diputados, textvariable=Nombre_completo_entr_var, state=DISABLED)
Nombre_completo_entr.place(x=150, y=60)

Provincia_buscador_lbl = Label(Buscador_diputados, text='Provincia: ', bg='black', fg='pink').place(x=20, y=90)
Provincia_buscador_entr_var = StringVar(Buscador_diputados)
Provincia_buscador_entr = Entry(Buscador_diputados, textvariable=Provincia_buscador_entr_var, state=DISABLED)
Provincia_buscador_entr.place(x=150, y=90)

cantidad_viajes_2_lbl = Label(Buscador_diputados, text='Cantidad de Viajes: ', bg='black', fg='pink').place(x=20, y=120)
cantidad_viajes_2_entr_var = StringVar(Buscador_diputados)
cantidad_viajes_2_entr = Entry(Buscador_diputados, textvariable=cantidad_viajes_2_entr_var, state=DISABLED)
cantidad_viajes_2_entr.place(x=150, y=120)

bloque_2_lbl = Label(Buscador_diputados, text='Bloque: ', bg='black', fg='pink').place(x=20, y=150)
bloque_2_entr_var = StringVar(Buscador_diputados)
bloque_2_entr = Entry(Buscador_diputados, textvariable=bloque_2_entr_var, state=DISABLED)
bloque_2_entr.place(x=150, y=150)

año_inicio_lbl = Label(Buscador_diputados, text='Año inicio: ', bg='black', fg='pink').place(x=20, y=180)
año_inicio_entr_var = StringVar(Buscador_diputados)
año_inicio_entr = Entry(Buscador_diputados, textvariable=año_inicio_entr_var, state=DISABLED)
